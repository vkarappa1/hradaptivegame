...
public abstract class ImageProcessing {
	...
	/*private static int decodeYUV420SPtoRedSum(int[] pixels) {
     ...
     */
   /* public static int decodeYUV420SPtoRedAvg(int[] pixels) {
        if (pixels == null) return 0;

        final int frameSize = pixels.length;

        int sum = decodeYUV420SPtoRedSum(pixels);
